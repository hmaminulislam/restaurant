    ...
    <div className="bg-white px-5">
      <div className="max-w-[1300px] mx-auto md:h-[100px] md:flex items-center justify-between overflow-hidden">
        <div className="flex md:flex-none items-center justify-between h-[60px] md:h-auto">
          <div>
            <Link to="/">
              <img className="w-[120px] z-[999]" src={Logo} alt="" />
            </Link>
          </div>
        ...
        <div className={`navbar ${!show ? "show-nav" : "hidden-nav"} z-[999]`}>
            ...
            <form className="text-center">
              ...
              <div className="mt-3">
                <input
                  ...
                  min={minDate}
                  max={maxDate}
                  className="input input-bordered w-full max-w-xs date"
                />
              </div>
              <select
                name="time"
              ...
              <button className="btn-bg-primary w-full max-w-xs text-white py-3 mt-4 rounded">
                BOOK NOW
              </button>
            </form>
          </div>
